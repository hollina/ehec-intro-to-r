...
author:
  name: Alex Hollingsworth, Grant McDermott, and Kelli R Marquardt
...
output: 
  html_document:
    ...
    toc_depth: 4
    toc_float: yes
    css: introduction/css/preamble.css ## For multi-col environments
  pdf_document:
    ...
    includes:
      in_header: introduction/tex/preamble.tex ## For multi-col environments
    pandoc_args:
        --template=introduction/tex/mytemplate.tex ## For affiliation field. See: https://bit.ly/2T191uZ
