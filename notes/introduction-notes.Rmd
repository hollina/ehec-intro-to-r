...
Now we can run all sorts of other models and display them side-by-side. We will use `fixest` to run a regression with fixed effects. 
...
Store these two models as a list 
...
etable(fe_model, 
    ...
    kable_styling()
```
See more options here, https://cran.r-project.org/web/packages/kableExtra/vignettes/awesome_table_in_html.html
